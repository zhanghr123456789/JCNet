...
def create_human_tree(data_type="human36m"):
    ...
    if data_type == "human36m":
        human_tree = DictTree(17, {"name":"Hip", "index":0})
        human_tree.create_node("RHip", 1, parent=0)
        human_tree.create_node("RKnee", 2, parent=1)
        human_tree.create_node("RFoot", 3, parent=2)
        human_tree.create_node("LHip", 4, parent=0)
        human_tree.create_node("LKnee", 5, parent=4)
        human_tree.create_node("LFoot", 6, parent=5)
        human_tree.create_node("Spine", 7, parent=0)
        human_tree.create_node("Thorax", 8, parent=7)
        human_tree.create_node("Neck", 9, parent=8)
        human_tree.create_node("Head", 10, parent=9)
        human_tree.create_node("LShoulder", 11, parent=8)
        human_tree.create_node("LElbow", 12, parent=11)
        human_tree.create_node("LWrist", 13, parent=12)
        human_tree.create_node("RShoulder", 14, parent=8)
        human_tree.create_node("RElbow", 15, parent=14)
        human_tree.create_node("RWrist", 16, parent=15)
        human_tree.left_bones = [4, 5, 6, 11, 12, 13]
        human_tree.right_bones = [1, 2, 3, 14, 15, 16]
        human_tree.middle_bones = [7, 8, 9, 10]
    elif data_type == "totalcapture":
        human_tree = DictTree(16, {"name":"Hip", "index":0})
        human_tree.create_node("RHip", 2, parent=0)
        human_tree.create_node("RKnee", 1, parent=2)
        ...
        human_tree.right_bones = [2, 1, 6, 12, 11, 10]
        human_tree.middle_bones = [7, 8, 9]
    elif data_type == "occlusion_human":
        ...
        human_tree.create_node("Spine", 7, parent=0)
        human_tree.create_node("Thorax", 8, parent=7)
        human_tree.create_node("LShoulder", 9, parent=8)
        human_tree.create_node("LElbow", 10, parent=9)
        human_tree.create_node("LWrist", 11, parent=10)
        human_tree.create_node("RShoulder", 12, parent=8)
        human_tree.create_node("RElbow", 13, parent=12)
        human_tree.create_node("RWrist", 14, parent=13)
        human_tree.left_bones = [4, 5, 6, 9, 10, 11]
        human_tree.right_bones = [1, 2, 3, 12, 13, 14]
        human_tree.middle_bones = [7, 8]
    human_tree.get_conv_mat()
